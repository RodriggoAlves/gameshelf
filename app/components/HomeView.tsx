...
export default function HomeView({ popularGames, libraryIds }: { popularGames: Game[], libraryIds: number[] }) {
  ...
  useEffect(() => {
    // Scroll nativo (CSS scroll-snap) entrega a melhor performance "lisa" no mobile.
    // O auto-scroll via JS conflitava com o touch (arraste) do usuário.
  }, []);
  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <section className={styles.glitchSection}>
          <Link href="/roadmap" className={styles.glitchBanner}>
            <div className={styles.glitchIcon}>
              <LucideIcons.Terminal size={24} />
            </div>
            <div className={styles.glitchText}>
              <span className={styles.glitchWarning}>[SISTEMA_DETECTADO]</span>
              <span className={styles.glitchMessage}>ACESSAR ARQUIVOS CONFIDENCIAIS (ROADMAP_ZEREY.EXE)</span>
            </div>
            <div className={styles.glitchArrow}>
